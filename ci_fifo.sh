...
#leofs1-manager:
salt alpha_test_leofs1 cmd.run 'svcadm enable epmd' shell='/usr/bin/bash'
salt alpha_test_leofs1 cmd.run 'svcadm enable leofs/manager' shell='/usr/bin/bash'
sleep 5
salt alpha_test_leofs1 cmd.run 'svcs   leofs/manager'  shell='/usr/bin/bash'

#leofs2-manager:
salt alpha_test_leofs2 cmd.run  'svcadm enable epmd'  shell='/usr/bin/bash'
salt alpha_test_leofs2 cmd.run  'svcadm enable leofs/manager'  shell='/usr/bin/bash'
sleep 5
salt alpha_test_leofs2 cmd.run  'svcs   leofs/manager'  shell='/usr/bin/bash'

#leofs1-storage:
salt alpha_test_leofs1 cmd.run 'svcadm enable leofs/storage' shell='/usr/bin/bash'
sleep 5
salt alpha_test_leofs1 cmd.run 'svcs   leofs/storage' shell='/usr/bin/bash'
salt alpha_test_leofs1 cmd.run 'leofs-adm status' shell='/usr/bin/bash'
salt alpha_test_leofs1 cmd.run 'leofs-adm start' shell='/usr/bin/bash'

salt alpha_test_leofs1 cmd.run 'svcadm enable leofs/gateway' shell='/usr/bin/bash'
salt alpha_test_leofs1 cmd.run 'svcs   leofs/gateway' shell='/usr/bin/bash'
sleep 5
salt alpha_test_leofs1 cmd.run 'leofs-adm status'  shell='/usr/bin/bash'
