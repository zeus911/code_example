...
dataset_repository:
    dataset_test_mustang:
       ...
       programm_files:
          mustang.sh: 'http://192.168.10.56:5000/devops/megatron/raw/master/RabbitMQ/install.sh'
    ...
    dataset_test_FileServer_NFS:
       ...
       programm_files:
          FileServer: 'http://192.168.10.56:5000/devops/megatron/raw/master/RabbitMQ/install.sh'
