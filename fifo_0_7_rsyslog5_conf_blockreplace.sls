...
rsyslog.conf-blockreplace:
  file.blockreplace:
    ...
    - content: |
            ...
            # File access
            $InputFileName /var/log/{{ fifo_module}}/console.log
            ...
            $InputFileName /var/log/{{ fifo_module}}/crash.log
            ...
            $InputFileName /var/log/{{ fifo_module}}/run_erl.log
            ...
            $InputFileName /var/log/{{ fifo_module}}/error.log
