...
salt -L 'lakala.wu'   cmd.run "vmadm list  | grep old_fifo_home_1  | awk '{print $1 }' |xargs -I {} sh -c 'vmadm update {}   indestructible_delegated=false;vmadm delete {}'"
...
salt lakala.wu      state.sls_id   create_old_fifo_home_1_vm          create_fifo_vm  -t 600
salt lakala.wu      state.sls_id   dataset_install_old_fifo_home_1    config_smartos_vm -t 3600
